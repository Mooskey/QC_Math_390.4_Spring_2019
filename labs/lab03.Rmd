...
The alignment of dots almost beg to have a line of negative slope. In terms of the SVM, this line strictly separates; it clearly does not create a maximum wedge.
...
pacman::p_load(e1071)
?svm
svm_model = svm(X_simple_feature_matrix,y=y_binary)
```
